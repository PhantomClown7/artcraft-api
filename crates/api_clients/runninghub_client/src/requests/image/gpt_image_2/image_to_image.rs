...
const ENDPOINT: &str = "/openapi/v2/rhart-image-g-2/image-to-image";

#[derive(Debug, Clone)]
pub struct GptImage2ImageToImageRequest {
  pub prompt: String,
...
impl GptImage2ImageToImageRequest {
  pub async fn send(&self, api_key: &RunninghubApiKey) -> Result<String, RunninghubError> {
    ...
    log::info!("RunningHub GptImage2 image-to-image task enqueued: {}", task_id);
