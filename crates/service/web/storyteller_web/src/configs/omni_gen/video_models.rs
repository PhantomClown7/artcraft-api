...
fn build_omni_gen_video_models() -> Vec<OmniGenVideoModelDetails> {
  ...
  models.push(OmniGenVideoModelDetails {
    ...
    extra_info: Some("Original Seedance 2.0".to_string()),
    extra_info_short: Some("The Chinese Volcengine (ByteDance China API platform) version of Seedance 2.0. Checkpoint is from January 2026. This may be better at some characters than the other Seedance models.".to_string()),
    text_prompt_supported: Some(true),
    starting_keyframe_supported: Some(true),
    ending_keyframe_supported: Some(true),
    image_references_supported: Some(true),
  ...
  models.push(OmniGenVideoModelDetails {
    ...
    extra_info: Some("Original Seedance 2.0 Fast".to_string()),
    extra_info_short: Some("The Chinese Volcengine (ByteDance China API platform) version of Seedance 2.0 Fast. Checkpoint is from January 2026. This may be better at some characters than the other Seedance models.".to_string()),
    text_prompt_supported: Some(true),
    starting_keyframe_supported: Some(true),
    ending_keyframe_supported: Some(true),
    image_references_supported: Some(true),
  ...
  models.push(OmniGenVideoModelDetails {
    ...
    extra_info: Some("Seedance 2.0 (BytePlus version)".to_string()),
    extra_info_short: Some("The Chinese BytePlus (ByteDance's Western API platform) version of Seedance 2.0. This has fewer restrictions on faces and IP.".to_string()),
    text_prompt_supported: Some(true),
    starting_keyframe_supported: Some(true),
    ending_keyframe_supported: Some(true),
    image_references_supported: Some(true),
  ...
  models.push(OmniGenVideoModelDetails {
    ...
    extra_info: Some("Seedance 2.0 Fast (BytePlus version)".to_string()),
    extra_info_short: Some("The Chinese BytePlus (ByteDance's Western API platform) version of Seedance 2.0 Fast. This has fewer restrictions on faces and IP.".to_string()),
    text_prompt_supported: Some(true),
    starting_keyframe_supported: Some(true),
    ending_keyframe_supported: Some(true),
    image_references_supported: Some(true),
  ...
  models.push(OmniGenVideoModelDetails {
    ...
    extra_info: Some("Seedance 2.0 (BytePlus version); less filtered".to_string()),
    extra_info_short: Some("This is the same BytePlus version of Seedance 2.0, but with even fewer restrictions around content. Horror movies, action movie violence, and more is possible.".to_string()),
    text_prompt_supported: Some(true),
    starting_keyframe_supported: Some(true),
    ending_keyframe_supported: Some(true),
    image_references_supported: Some(true),
  ...
  models.push(OmniGenVideoModelDetails {
    ...
    extra_info: Some("Seedance 2.0 Fast (BytePlus version); less filtered".to_string()),
    extra_info_short: Some("This is the same BytePlus version of Seedance 2.0 Fast, but with even fewer restrictions around content. Horror movies, action movie violence, and more is possible.".to_string()),
    text_prompt_supported: Some(true),
    starting_keyframe_supported: Some(true),
    ending_keyframe_supported: Some(true),
    image_references_supported: Some(true),
